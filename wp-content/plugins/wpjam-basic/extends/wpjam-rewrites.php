...
class WPJAM_Rewrite{
	...
	public static function load_plugin_page(){
		wpjam_register_plugin_page_tab('rules',		['title'=>'Rewrites 规则',	'function'=>'list',		'load_callback'	=>['WPJAM_Rewrite', 'load_list_table_page']]);
		wpjam_register_plugin_page_tab('optimize',	['title'=>'Rewrites 优化',	'function'=>'option',	'option_name'=>'wpjam-basic',	'load_callback'	=>['WPJAM_Rewrite', 'load_option_page']]);
	}
