...
trait WPJAM_Meta_Trait{
	public function add_meta($meta_key, $meta_value, $unique = false){
		return add_metadata(self::$meta_type, $this->id, $meta_key, $meta_value, $unique);
	}

	public function delete_meta($meta_key, $meta_value = ''){
		return delete_metadata(self::$meta_type, $this->id, $meta_key, $meta_value);
	}

	public function get_meta($key = '', $single = false){
		return get_metadata(self::$meta_type, $this->id, $key, $single);
	}

	public function update_meta($meta_key, $meta_value, $prev_value = ''){
		return update_metadata(self::$meta_type, $this->id, $meta_key, $meta_value, $prev_value);
	}
	...
	public static function lazyload_meta($check) {
	...
	public static $meta_lazyloader;

	public static function get_meta_lazyloader(){
		if(null === $meta_lazyloader){
			$meta_lazyloader = new WPJAM_Lazyloader(self::$meta_type, 'get_'.self::$meta_type.'_metadata', ['self', 'lazyload_meta']);
		}

		return $meta_lazyloader;
	}
}
