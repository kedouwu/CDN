...
function wp_login_to_read($atts, $content = null) {
	...
	<div class="content-hide-tips"><i class="fa fa-lock"></i><span class="rate label label-warning">开通蝌蚪会员享专属福利大礼包，全站免费查看</span><div class="login-false"><b><font color="red">抱歉，当前隐藏内容需成功登录后免费查看！</font></b></div><br><div class="pc-button"><button type="button" class="login-btn btn btn--primary"><i class="fa fa-user"></i> 登录/注册</button></div></div>'), $atts));
