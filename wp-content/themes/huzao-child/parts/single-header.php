...
<div class="cao_entry_header">
    <div class="sjblog-tgroup">
	  ...
	  <span class="sjblog-name" style="color: #6b6b6b;">作者 :   
	                  <a <?php echo _target_blank(); ?> href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>" style="color: #6b6b6b;"><?php the_author(); ?></a>
	                  
	                  <?php if (_cao('sucaihu_ui_article_xnumber')) : ?>
	                  <span class="sjblog-views"><i class="fa fa-pencil-square-o"></i> <?php echo count_words_read_time(); ?></span>
	                  <?php endif; ?>
	                  
	                  <?php if (_cao('sucaihu_ui_article_time')) : ?>
	                  <span class="sjblog-time"> 发布时间：<i class="fa fa-clock-o"></i> <?php echo the_time('Y-m-j'); ?></span>
	                  <?php endif; ?>
	                  
	                  <?php if (_cao('sucaihu_ui_article_statisticsr')) : ?>
