...
<head>
  ...
  <title><?php echo _title() ?></title>
    ...
    <![endif]-->
    <?php if (_cao('sucaihu_ui_cannotcopy')) : ?>
    <script src="<?php echo get_stylesheet_directory_uri() ?>/assets/js/sucaihu.jquery.cannotcopy.js"></script>
    <?php endif;?>
    <script src="<?php echo get_stylesheet_directory_uri() ?>/assets/js/sucaihu.jquery.waypoints.js"></script>
