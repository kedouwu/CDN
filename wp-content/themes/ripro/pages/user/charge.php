                            ...
                            <div class="charge">
                                ...
                                <div class="modules__content">
                                    ...
                                    <div id="kamidiv" <?php echo $cdk_display;?>>
                                        ...
                                        <h2> 充值说明：</h2>
                                        <p><h2>一、中国境内</p></h2>
                                       <p><h3><font color="red"> 如果华人目前身处中国境内，请前往发卡平台购买卡密进行余额充值。支持支付宝、微信、QQ等支付方式。（因寄售卡密的平台服务器在中国境内，访问其网站时最好将vpn关闭，以免影响支付）</p></h3></font>
                                        <?php
                                        $cdk_charge_href = _cao('cdk_charge_href');
                                        if ($cdk_charge_href != '') {
                                            echo '<a class="btn btn--secondary btn--block" target="_blank" href="'.$cdk_charge_href.'">点击前往发卡平台购买卡密</a>';
                                         }
                                         ?>
                                         <p></p>
                                         <p><h2>二、其它境内</p></h2>
                                       <p><h3><font color="#8904B1">其他国家的华人购买卡密使用“PayPal”支付方式，目前Paypal支持各个国家的银行进行支付。</font></h3></p>
                                       <p><h3><font color="#0080FF">  1.如果你有PayPal账户，请直接在付款中输入“付款邮箱”向我付款。付款时请留言你在蝌蚪屋注册时的“邮箱账号”或者“昵称”，我们将在后台根据你的付款金额为你的账户进行充值等价的余额。</h3></font></p>
<div class="modules__title">
                <h3 class="mb-0">付款邮箱：<span id="refurl" class="label label-info" data-clipboard-text="kedouwu@gmail.com" style="background-color: #5882FA;font-weight: 500;cursor: pointer;">kedouwu@gmail.com</span></h3>
            </div>                                      
                                       <p><h3><font color="#0101DF">  2.如果你没有PayPal账户又不想注册，没关系，请向我们的“收信邮箱”发送以下内容（我们收到邮件后将把“付款单"发送至你的邮箱）：</font></h3>
                                       <p><h4><font color="#DF3A01">a.为账号充值蝌蚪币的数量（需为整数）<br>b.接收”PayPal付款账单“的邮箱（自己的电子邮箱）</font></h4></p>
<html lang="en">    
<p><h3><head>    
    <meta charset="UTF-8">    
...
<body>    
<font color="#0101DF">收信邮箱：</font><br><span id="target1">yp@kedouwu.xyz</span>
<button class="btn" data-clipboard-action="copy" data-clipboard-target="#target1" id="copy_btn">    
    <align="center">点击复制    
</button> 
</body>    
 <script>    
    $(document).ready(function(){      
        ...
        clipboard.on('success', function(e) {    
            alert("复制成功：yp@kedouwu.xyz",1500);
            e.clearSelection();    
            console.log(e.clearSelection);    
                                       ...
                                       <h2> 汇率说明：</h2>
                                       <p><h3>1蝌蚪币=1元，1蝌蚪币=1.2港币，10蝌蚪币=12港币，50蝌蚪币=60港币。<br><font color="red">使用PayPal交易时为了减少麻烦，币种都采用港币进行付款。</font></h3></p></p>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
